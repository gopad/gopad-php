...
class GroupApi
{
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gopad\Model\InlineObject2|\Gopad\Model\Notification|\Gopad\Model\Notification|\Gopad\Model\Notification
     */
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gopad\Model\InlineObject2|\Gopad\Model\Notification|\Gopad\Model\Notification|\Gopad\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gopad\Model\InlineObject2';
        $request = $this->listGroupUsersRequest($groupId, $search, $sort, $order, $limit, $offset, $contentType);
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gopad\Model\InlineObject1|\Gopad\Model\Notification|\Gopad\Model\Notification
     */
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gopad\Model\InlineObject1|\Gopad\Model\Notification|\Gopad\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gopad\Model\InlineObject1';
        $request = $this->listGroupsRequest($search, $sort, $order, $limit, $offset, $contentType);
