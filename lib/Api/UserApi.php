...
class UserApi
{
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gopad\Model\InlineObject4|\Gopad\Model\Notification|\Gopad\Model\Notification|\Gopad\Model\Notification
     */
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gopad\Model\InlineObject4|\Gopad\Model\Notification|\Gopad\Model\Notification|\Gopad\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gopad\Model\InlineObject4';
        $request = $this->listUserGroupsRequest($userId, $search, $sort, $order, $limit, $offset, $contentType);
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gopad\Model\InlineObject3|\Gopad\Model\Notification|\Gopad\Model\Notification
     */
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gopad\Model\InlineObject3|\Gopad\Model\Notification|\Gopad\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gopad\Model\InlineObject3';
        $request = $this->listUsersRequest($search, $sort, $order, $limit, $offset, $contentType);
