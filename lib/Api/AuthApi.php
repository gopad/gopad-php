...
class AuthApi
{
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gopad\Model\InlineObject
     */
     ...
     * @throws \Gopad\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gopad\Model\InlineObject, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gopad\Model\InlineObject';
        $request = $this->listProvidersRequest($contentType);
